...
class TarjetaFruta extends Component {
  constructor(props) {
    ...
    // bindeo o binding sobre los métodos que el this pierde el contexto de
    // de clase.
  ...
  quitar() {
    return this.state.cantidad > 0
      ? this.setState({ cantidad: this.state.cantidad - 1 })
      : this.setState({ cantidad: 0 });
  }
  limpiar = () => this.setState({ cantidad: 0 }); // sin bind
  render() {
    return (
      <div>
...
// y lo configura con unas características aceptadas
// por la comunidad, pero no son un estandar de programación.
/*
class TarjetaFruta extends Component {
  // no hay constructor
  state = {
